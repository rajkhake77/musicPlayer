        ...
        <>
            <div className='w-full flex justify-between items-center font-semibold'>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <p className='bg-black text-white text-[15px] px-6 py-2 rounded-2xl cursor-pointer'>Install App</p>
                    <p className='bg-purple-500 text-white w-7 h-7 rounded-full flex items-center justify-center'>P</p>
                </div>
            </div>
